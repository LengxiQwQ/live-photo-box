...
namespace LivePhotoBox.Services.Protocols
{
    ...
    public sealed class OppoLivePhotoProtocol : LivePhotoProtocol
    {
            ...
            string sourceImagePath, string workDir, CancellationToken token)
        {
            ...
            // If exiftool is not available, skip marker injection and warn the user
            ...
            // Create a temporary copy of the source image for EXIF modification
            ...
            // Inject the OPPO EXIF UserComment marker via exiftool
