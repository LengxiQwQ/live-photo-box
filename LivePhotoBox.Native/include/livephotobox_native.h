...
#define LPB_PRESERVATION_STATUS_UNABLE_TO_VERIFY       2
...
typedef enum lpb_preservation_check_category {
    ...
    LPB_PCHECK_EXIF = 2,
    LPB_PCHECK_ORIENTATION = 3,
    LPB_PCHECK_GPS = 4,
    LPB_PCHECK_ICC = 5,
    LPB_PCHECK_MAKERNOTE = 6,
    LPB_PCHECK_XMP_NON_TARGET = 7,
    LPB_PCHECK_EXTENDED_XMP = 8,
    LPB_PCHECK_HDR_GAINMAP = 9,
    LPB_PCHECK_HDR = 9,
    LPB_PCHECK_GAINMAP = 10,
    LPB_PCHECK_VIDEO_STREAMS = 11,
    LPB_PCHECK_AUDIO_STREAMS = 12,
    LPB_PCHECK_TIMING = 13
} lpb_preservation_check_category;

/* A single verdict */
typedef struct lpb_preservation_verdict {
    uint32_t category; /* lpb_preservation_check_category */
    uint32_t status;   /* LPB_PRESERVATION_STATUS_* */
    char details[256]; /* Human readable detail string generated by Native */
} lpb_preservation_verdict;
 ...
 * out_overall_passed: Returns 1 if all applicable checks passed, 0 if any failed.
 */
