...
namespace LivePhotoBox.Views
{
    public sealed partial class MergePage : Page
    {
        ...
        private void ShowTutorialStep(int index)
        {
            ...
            // 正文：按 **粗体** 标记拆分为多个 TextBlock 段落（每段独立 FontWeight，行距自然）
            ...
            TutorialTip.ActionButtonContent = step.IsLast ? null : ResourceService.GetString("MergeTutorial_Btn_Next");
        ...
        private void BuildTutorialSteps()
        {
            ...
            _tutorialSteps.Add(new TutorialStep
            {
                ...
                TitleKey = "MergeTutorial_Step01_Title",
                ContentKey = "MergeTutorial_Step01_Content",
